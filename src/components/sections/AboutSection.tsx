        ...
        <div className="grid md:grid-cols-1 gap-8 items-center">
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="mt-4">
                <h4 className="font-semibold text-primary mb-2 text-lg text-foreground/90 leading-relaxed">Key Strengths:</h4>
                <ul className="list-disc list-inside space-y-1 text-lg text-foreground/90 leading-relaxe">
